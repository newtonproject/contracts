...
// File contracts/CryptoScientists.sol

pragma solidity ^0.8.0;

contract AndromedaNFT is ERC721 {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return _token_hash[tokenId];
    }

    function getTokenInfo(uint256 tokenId) public view  returns (string memory url,address creator,uint256 blockNumber) {
         require(_exists(tokenId), "nonexistent token");
         return (_token_hash[tokenId],id2Creator[tokenId],id2BlockNumber[tokenId]);
    }
