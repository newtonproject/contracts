 ...
 */
contract NRC7FullPublic is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, ERC2981PerTokenRoyalties {
   ...
   /**
    ...
    function _mintItemTo(
        ...
        _setTokenRoyalty(tokenId, royaltyRecipient, royaltyRate);
    ...
    function mintItem(
        ...
        return _mintItemTo(msg.sender, _tokenURI, royaltyRate, royaltyRecipient);
    }
    ...
    function mintItemTo(
        ...
        return _mintItemTo(to, _tokenURI, royaltyRate, royaltyRecipient);
    }
